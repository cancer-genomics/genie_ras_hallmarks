---
title: "Response to Reviews 2:  Additional GSEA Analyses"
...
plot_titles <- paste0(comutant, ' only mutant vs wild type COAD')
```
...
```{r resp-to-reviewers-2-1, fig.width=25, fig.height=30, dev=c("png", "pdf")}
