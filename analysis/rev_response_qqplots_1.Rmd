---
title: "Response to Reviews 1:  Additional GSEA Analyses"
...
library(gridExtra)
library(rasfuns)
# devtools::load_all(here('rasfuns'))
```
...
plot_titles <- paste0(comutant, ' only mutant vs wild type LUAD')
```
...
```{r resp-to-reviewers-1-1, fig.width=25, fig.height=45, dev=c("png", "pdf")}
...
grid.arrange(grobs=rank.gg2[1:5],
