...
set.seed(INDEX)
library(here)
outdir <- here("output", "co-mutation", "driver_cosmic_allele_gp_mutsig.R")
...
data(driver_cosmic_allele_gp_msig, package="contingency.table")
mt  <- driver_cosmic_allele_gp_msig %>%
  unnest(data)  %>%
